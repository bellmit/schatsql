...
data class ChatGroup(
    ...
    @Column(name = "wids", columnDefinition = "MEDIUMTEXT")
    var wids: String = "",
    @Column(name = "display_names", columnDefinition = "MEDIUMTEXT")
    var displayNames: String = "",
    @Column(name = "show_member_nicknames", columnDefinition = "MEDIUMTEXT")
    var showMemberNicknames: String = "",
    @Column(name = "member_names", columnDefinition = "MEDIUMTEXT")
